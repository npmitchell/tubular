function plotPathlineIntegratedStrainTimePoint(QS, tp, options)
%plotPathlineStrainRateTimePoint(QS, tp, options)
%   Plot the traceful and traceless components of the integrated strain
%   tensor defined at pathlines moving in the domain of parameterization 
%   over time.
...
error('Currently this function plots Strain RATE --> convert to integrated strain')
