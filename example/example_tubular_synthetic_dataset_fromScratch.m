...
%% Add paths
dataDir = '/mnt/data/tubular_test/single_coil_dynamic_fromScratch/' ;  % This is the path where the example dataset is downloaded
...
if ~exist(fullfile(dataDir, 'xp.mat'), 'file')
    ...
    if ~exist('./masterSettings.mat', 'file') || overwrite
        ...
        timePoints = 0:20;       % timepoints to include in the analysis
...
tubi.xp.detectOptions.tension = 1 ;
tubi.xp.detectOptions.niter0 = 600 ;
tubi.xp.detectOptions.niter = 500 ;
tubi.xp.detectOptions.post_pressure = 1 ;
tubi.xp.detectOptions.radius_guess = 15 ;
tubi.xp.detectOptions.smooth_with_matlab = 0.5 ;
