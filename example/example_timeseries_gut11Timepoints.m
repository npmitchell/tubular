...
%% Set metadata for this experiment and set options for TubULAR parameterization
...
nU = 100 ;                  % how many discrete values of longitudinal coordinate are in remeshed parameterization after stabilization
nV = 100 ;                  % how many discrete values of circumferential coordinates are in the remeshed parameterization

dir16bit = fullfile(dataDir) ;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PART 1: Define the metadata for the project, using ImSAnE conventions
% Note: not all these options are used by TubULAR, but follow the ImSAnE
% convention since the two can be used together (TubULAR and ImSAnE)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Note: not all of these are used by TubULAR, but we stick to the ImSAnE
% detectOptions conventions. 
